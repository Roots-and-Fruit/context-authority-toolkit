...
| `includes/class-cat-term-section-block.php` | Term-section block + `cat-toolkit/term-page` inserter pattern; heading i18n (`Cat_Term_Section_Block`) |
| `assets/blocks/cat-term-section/` | Dynamic term-section block (`block.json` + editor + PHP `render_callback`) |
